...
<html>
  ...
  <body>
    ...
    <div class="container">
        ...
        <tbody>
          <c:forEach items="${buses}" var="bus" >
            <tr>
              ...
              <td>
                <spring:url value="/bus/${bus.id}/edit" var="editURL" />
                <a class="btn btn-info" href="${editURL}" role="button" >Edytuj</a>
              </td>
              <td>
                <spring:url value="/bus/${bus.id}/delete" var="deleteURL" />
      ...
      <a class="btn btn-success" href="${addURL}" role="button" >Dodaj autobus</a>
    </div>
  </body>
